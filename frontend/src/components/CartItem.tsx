...
const CartItem = ({ product }: CartItemProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex grow justify-center">{product.name}</div>
      <div className="flex grow justify-center">${product.price / 100}</div>
      <div className="flex basis-[40px] grow-0 shrink-0 gap-2 items-center">
